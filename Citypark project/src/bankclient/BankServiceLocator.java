...
public class BankServiceLocator extends org.apache.axis.client.Service implements bankclient.BankService {
    ...
    private java.lang.String Bank_address = "http://192.168.1.100:8080/Bank(1)/services/Bank";
    ...
    public bankclient.Bank getBank(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bankclient.BankSoapBindingStub _stub = new bankclient.BankSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bankclient.Bank.class.isAssignableFrom(serviceEndpointInterface)) {
                bankclient.BankSoapBindingStub _stub = new bankclient.BankSoapBindingStub(new java.net.URL(Bank_address), this);
                _stub.setPortName(getBankWSDDServiceName());
                return _stub;
            }
        }
